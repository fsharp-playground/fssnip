module Validation =
    ...
    let CreateValidator (f: 'e -> ('e Test list -> 'e Test list)) =  f Unchecked.defaultof<_> []

    let Validate entity = List.choose (fun (Test test) -> test entity)
...
let validResult = Validate acc accountValidator