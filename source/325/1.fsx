...
let readFile (file:string) (result:CList<'a>) (f:byte[] -> 'a) =
  async {
...
let rec readDir (dir:string) (result:CList<'a>) (f:byte[] -> 'a) =
  seq {
...
let rec collectFiles<'a> (dir:string) (f:byte[] -> 'a) =
...
let result = 
  collectFiles<int> @"C:\Users\Fredrik\Projects\IronJS" (fun b -> b.Length)