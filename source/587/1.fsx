...
/// Find the lowest terms of a fraction - eg. 2/4 --> 1/1
let lowestTerms n d = 
    if n <= 0 || d <= 0 then
        1, 1
    else
...
/// Convert a floating point number to the nearest mixed number using the specified numerator and denominator - eg. 1,3,1.666 --> 1 2/3
