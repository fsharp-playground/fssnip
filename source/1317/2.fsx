...
let pcases =  between (str_ws "{") (str_ws "}") (many pcaseblock)
...
let pclass = 
    pipe5 paccess (opt pmodifier) (str_ws1 "class") pidentifier_ws pmembersblock
...
namespace A { 
  ...
  class A { 
    ...
    bool foo(string arg) {
      for(int i = 0; true; i) { }
      switch(y) { case 0: break; case 1: y = 1; }
      bool x;
      x = true;      
      while(x) { 
